...
const AppsDetails = () => {
    ...
    const installed = installedIds.map(String).includes(String(app.id));

    const handleInstall = () => {
        const success = addToInstalledApps(app.id, setInstalledIds);
        if (success) {
                ...
                <div className="flex flex-col md:flex-row gap-10">
                    ...
                    <div className="flex-1 space-y-7">
                        ...
                        <button
                            ...
                            disabled={installed}
                            className={`mt-4 ${installed ? "bg-[#627382] cursor-not-allowed" : "bg-[#00D390] hover:bg-green-600 cursor-pointer"} text-xl font-semibold text-white px-5 py-2 rounded-lg`}
                        >
