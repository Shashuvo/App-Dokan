...
const Navbar = () => {
    const links = <>
        <NavLink to="/" className="font-semibold"><a>Home</a></NavLink>
        <NavLink to="/apps" className="font-semibold"><a>Apps</a></NavLink>
        <NavLink to="/installed" className="font-semibold"><a>Installation</a></NavLink>
    </>
    return (
        <div className='bg-white shadow-sm'>
            <div className="navbar w-full md:w-11/12 mx-auto">
                ...
                <div className="navbar-end">
                    <a href='https://github.com/Shashuvo' target='_blank' className="btn bg-linear-to-r from-[#632EE3] to-[#9F62F2] text-white font-semibold"><FaGithub className='w-5 h-5' /> Contribute</a>
                </div>
            </div>
        </div>
    );
